...
$(document).ready(function(){
    var url = $("#bgvideo").attr('src');
    
    $("#bgvideo").attr('src', '');
	
    $("#background").on('shown.bs.modal', function(){
        $("#bgvideo").attr('src', url);
    });

    $("#background").on('hide.bs.modal', function(){
        $("#bgvideo").attr('src', '');
    });
});
...
$(document).ready(function(){
    var url = $("#stickervideo").attr('src');
    
    $("#stickervideo").attr('src', '');
	
    $("#sticker").on('shown.bs.modal', function(){
        $("#stickervideo").attr('src', url);
    });

    $("#sticker").on('hide.bs.modal', function(){
        $("#stickervideo").attr('src', '');
    });
});
...
$(document).ready(function(){
    var url = $("#artvideo").attr('src');
    
    $("#artvideo").attr('src', '');
	
    $("#art").on('shown.bs.modal', function(){
        $("#artvideo").attr('src', url);
    });

    $("#art").on('hide.bs.modal', function(){
        $("#artvideo").attr('src', '');
    });
});
...
$(document).ready(function(){
    var url = $("#effectvideo").attr('src');
    
    $("#effectvideo").attr('src', '');
	
    $("#effect").on('shown.bs.modal', function(){
        $("#effectvideo").attr('src', url);
    });

    $("#effect").on('hide.bs.modal', function(){
        $("#effectvideo").attr('src', '');
    });
});
...
$(document).ready(function(){
    var url = $("#textvideo").attr('src');
    
    $("#textvideo").attr('src', '');
	
    $("#text").on('shown.bs.modal', function(){
        $("#textvideo").attr('src', url);
    });

    $("#text").on('hide.bs.modal', function(){
        $("#textvideo").attr('src', '');
    });
});
